<script lang="ts">
	...
	const colorClasses = $derived.by(() => {
		...
		let disabledClasses =
			'opacity-50 ' + (waitOnDisabled ? 'cursor-wait ' : '');
		...
		if (primary) {
			...
			return {
				...
				focusClasses:
					focusClasses +
					`focus-not-active:bg-gray-50 dark:focus-not-active:bg-gray-800`,
				activeClasses:
					activeClasses +
					`active:bg-gray-100 active:border-gray-50 dark:active:bg-gray-900 dark:active:border-gray-800`,
				activatedClasses:
					activatedClasses +
					`bg-gray-100 border-gray-50 dark:bg-gray-900 dark:border-gray-800`,
				disabledClasses,
			};
		} else if (tertiary) {
			return {
				...
				hoverClasses:
					hoverClasses +
					`hover:text-gray-600 hover:bg-gray-50 dark:hover:text-gray-300 dark:hover:bg-gray-900`,
				focusClasses:
					focusClasses +
				...
				activatedClasses:
					activatedClasses +
					`bg-transparent border-gray-50 text-gray-600 dark:text-gray-300 dark:border-gray-900`,
				disabledClasses,
			};
		} else if (danger) {
			return {
