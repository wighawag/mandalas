...
<section class="py-8 px-4 text-center">
  <div class="max-w-auto md:max-w-lg mx-auto">
    ...
    <div class="max-w-md mx-auto pt-1 mt-5 space-y-3 md:mt-8 md:space-y-5">
      <div
        ...
        <NavButton
          blank={true}
          class="big secondary"
          href="https://github.com/wighawag/generative-art"
    ...
    <div class="pt-3 pb-4 dark:bg-black bg-white">
      ...
      <code
        id="generative-art-command"
        on:click={select}
        class="mb-5 text-pink-600 font-black">npx degit wighawag/generative-art
        your-app-folder</code>
      <p class="mt-6">
        Find out more on
        <a
          class="underline"
          href="https://github.com/wighawag/generative-art#readme"
